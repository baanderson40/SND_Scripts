...
local RADZATHAN_VILLAGE_ID  = 963
local POETIC_ITEM_ID        = 28
...
local function RunsToGo()
    local perRun = tonumber(PoeticFromDung) or 0
    if perRun <= 0 then return 0 end
    local remaining = poeticLimit - PoeticOnHand()
...
local function MoveToRadzAtHan()
